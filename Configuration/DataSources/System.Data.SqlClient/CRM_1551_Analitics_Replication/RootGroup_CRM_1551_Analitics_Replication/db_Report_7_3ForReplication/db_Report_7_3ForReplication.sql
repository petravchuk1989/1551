declare @tab_All table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Agr table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Trans table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Finance table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Social table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Work table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Health table (source nvarchar(200), prev_val int, cur_val int);

--declare @dateFrom date = '2019-03-05';
