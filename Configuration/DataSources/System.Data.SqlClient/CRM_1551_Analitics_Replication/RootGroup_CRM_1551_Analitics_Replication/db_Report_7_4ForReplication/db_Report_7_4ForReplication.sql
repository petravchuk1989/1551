declare @tab_Com table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Res table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Eco table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Law table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Fam table (source nvarchar(200), prev_val int, cur_val int);
declare @tab_Sin table (source nvarchar(200), prev_val int, cur_val int);
