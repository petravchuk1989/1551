(function () {
  return {
    ...
    onChanged_Applicant_PIB_Input: function(value) {
         ...
         if(this.InitialState_Applicant_PIB == this.onChanged_Input(this.form.getControlValue('Applicant_PIB'))) {this.CheckParamForApplicant_PIB = 0} else {this.CheckParamForApplicant_PIB = 1};
          this.onChanged_Question_Aplicant_Btn_Add_Input();
    },
    onChanged_Applicant_Phone_Input: function(value) {
          ...
          if(this.InitialState_Applicant_Phone == this.onChanged_Input(this.form.getControlValue('CardPhone'))) {this.CheckParamForApplicant_Phone = 0} else {this.CheckParamForApplicant_Phone = 1};
          this.onChanged_Question_Aplicant_Btn_Add_Input();
    ...
    onChanged_Applicant_Entrance_Input: function(value) {
         ...
         if(this.InitialState_Applicant_Entrance == this.onChanged_Input(this.form.getControlValue('Applicant_Entrance'))) {this.CheckParamForApplicant_Entrance = 0} else {this.CheckParamForApplicant_Entrance = 1}; 
         this.onChanged_Question_Aplicant_Btn_Add_Input();
    },
    ...
    onChanged_Applicant_SocialStates_Input: function(value) {
        if (value == null || value == undefined) {
         ...
         if(this.InitialState_Applicant_SocialStates == this.onChanged_Input(this.form.getControlValue('Applicant_SocialStates'))) {this.CheckParamForApplicant_SocialStates = 0} else {this.CheckParamForApplicant_SocialStates = 1}; 
         this.onChanged_Question_Aplicant_Btn_Add_Input();
    },
    ...
    onChanged_Applicant_Privilege_Input: function(value) {
        if (value == null || value == undefined) {
         ...
         if(this.InitialState_Applicant_Privilege == this.onChanged_Input(this.form.getControlValue('Applicant_Privilege'))) {this.CheckParamForApplicant_Privilege = 0} else {this.CheckParamForApplicant_Privilege = 1}; 
         this.onChanged_Question_Aplicant_Btn_Add_Input();
    },
    ...
    onChanged_Question_Aplicant_Btn_Add_Input: function() {
       ...
       if(this.Applicant_Entrance_Input == "" || this.Applicant_PIB_Input == "" || this.Applicant_Phone_Input  == "" ||   this.Applicant_Building_Input == null 
    ...
    onChanged_Applicant_Type_Input: function(value) {
        if (value == null || value == undefined) {
           ...
           if(this.InitialState_Applicant_Type == this.onChanged_Input(this.form.getControlValue('Applicant_Type'))) {this.CheckParamForApplicant_Type = 0} else {this.CheckParamForApplicant_Type = 1};
          this.onChanged_Question_Aplicant_Btn_Add_Input();
    },
    ...
    //   if (this.form.getControlValue('Applicant_PIB')) {
    //       this.form.setGroupVisibility('Group_CreateQuestion', true);
    //   };
        
        if(this.Applicant_PIB_Input == "" || this.Applicant_Phone_Input  == "" ||  this.Applicant_Building_Input == null 
          ||  this.Applicant_Building_Input == undefined) {
           this.form.setGroupVisibility('Group_CreateQuestion', false);
       } else { 
           this.form.setGroupVisibility('Group_CreateQuestion', false);
