(function () {
  return {
    ...
    showFiltersValue: function(message){
        ...
        message.value.forEach( function(el){
            ...
            if(Number.isInteger(el.value) ||  el.code == 'appeals_user' ){
                ...
                if(  el.code == 'zayavnyk_full_name' ){
                    title = 'ПiБ'
                }
                else if(  el.code == 'appeals_files_check'){
                    title = 'Ознака',
                    el.value = 'Наявнiсть файлiв'
                }                
                else if(  el.code == 'zayavnyk_phone_number'){
                    title = 'Номер телефону'
                }                
                else if(  el.code == 'zayavnyk_entrance'){
                    title = 'Парадне'
                }                
                else if(  el.code == 'zayavnyk_email'){
                    title = 'E-mail'
                }                
                else if(  el.code == 'zayavnyk_flat'){
                    title = 'Квартира'
                }                
                else if(  el.code == 'question_registration_number'){
                    title = 'Номер питання'
                }                
                else if(  el.code == 'question_object'){
                    title = "Об'єкт"
                }                
                else if(  el.code == 'question_organization'){
                    title = 'Органiзацiя'
                }                
                else if(  el.code == 'assigm_executor_organization'){
                    title = 'Виконавець'
                }                
                else if(  el.code == 'assigm_question_content'){
                    title = 'Змiст'
                }
                else if( el.code ==  'registration_date'){
                    title = 'Поступило ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
                }            
                else if( el.code ==  'transfer_date'){
                    title = 'Передано ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
                }            
                else if( el.code == 'state_changed_date' ){
                    title = 'Розглянуто ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
                }            
                else if( el.code ==  'state_changed_date_done'){
                    title = 'На прозвон ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
                }            
                else if( el.code ==  'execution_term'){
                    title = 'Контроль ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
                }            
                else if( el.code ==  'state_change_date_close'){
                    title = 'Перевірено ';
                    let resultTitle = this.operation(el.operation, title);
                    title = resultTitle;
                    el.value = this.changeDateValue(el.value);
    ...
    createFilterElements: function(modalWindow){
        ...
        /* группа 2*/
        // const group2__element1_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox', name: 250, value: 'zayavnyk_full_name', id: 'zayavnyk_full_name' });
        // const group2__element1_title =  this.createElement('div', { className: 'group__element_title', innerText: 'ПiБ'});
        // const group2__element1 =  this.createElement('div', { className: 'group__element'}, group2__element1_checkBox, group2__element1_title);
        ...
        /*
        const group2__element3_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox',  value: 'zayavnyk_building_street', id: 'zayavnyk_building_street' });
        const group2__element3_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Вулиця'});
        const group2__element3 =  this.createElement('div', { className: 'group__element'}, group2__element3_checkBox, group2__element3_title);
        */
        // const group2__element11_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox',  name: 250,  value: 'zayavnyk_building_number', id: 'zayavnyk_building_number' });
        // const group2__element11_title =  this.createElement('div', { className: 'group__element_title', innerText: "Будинок"});
        ...
        // const group2__element5_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox',  name: 60,  value: 'zayavnyk_flat', id: 'zayavnyk_flat' });
        // const group2__element5_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Квартира'});
        // const group2__element5 =  this.createElement('div', { className: 'group__element'}, group2__element5_checkBox, group2__element5_title);
        ...
        // const group3__element1_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox',  value: 'question_registration_number', id: 'question_registration_number' });
        // const group3__element1_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Номер питання'});
        // const group3__element1 =  this.createElement('div', { className: 'group__element'}, group3__element1_checkBox, group3__element1_title);
        ...
        // const group3__element3_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox', name: 250, value: 'question_object', id: 'question_object' });
        // const group3__element3_title =  this.createElement('div', { className: 'group__element_title', innerText: "Об'єкт"});
        // const group3__element3 =  this.createElement('div', { className: 'group__element'}, group3__element3_checkBox, group3__element3_title);
        ...
        // const group3__element5_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox', name: 200, value: 'question_question_type', id: 'question_question_type' });
        // const group3__element5_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Тип питання'});
        // const group3__element5 =  this.createElement('div', { className: 'group__element'}, group3__element5_checkBox, group3__element5_title);
        ...
        const group3__container =  this.createElement('div', {  className: 'groupContainer'}, group1__title, group3__element2, group3__element4, group3__element6, group3__element7 );
         ...
         /* Группа 4*/
        // const group4__element1_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox', name: 200,  value: 'assigm_executor_organization', id: 'assigm_executor_organization' });
        // const group4__element1_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Виконавець'});
        // const group4__element1 =  this.createElement('div', { className: 'group__element'}, group4__element1_checkBox, group4__element1_title);        
        ...
        // const group5__element1_checkBox =  this.createElement('input', {type: 'checkbox', className: 'group__element_checkBox', name: 100, value: 'registration_date',  id: 'registration_date'});
        // const group5__element1_title =  this.createElement('div', { className: 'group__element_title', innerText: 'Поступило'});
        // const group5__element1 =  this.createElement('div', { className: 'group__element'}, group5__element1_checkBox, group5__element1_title);
